...
import com.timecat.module.timetable.activity.StationWebViewActivity;
...
public class StationManager {
    public static void openStationWithout(Activity context,StationModel stationModel){
        ...
        context.overridePendingTransition(R.anim.timetable_anim_station_open_activity,R.anim.timetable_anim_station_static);//动画
    }
