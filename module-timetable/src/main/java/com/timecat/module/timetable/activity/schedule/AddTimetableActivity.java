...
import com.timecat.module.timetable.activity.SelectWeekAdapter;
...
import com.timecat.module.timetable.model.AddModel;
...
public class AddTimetableActivity extends Activity {
    ...
    private void findView() {
        ...
        teacherEditText = (EditText) findViewById(R.id.et_teacher);
        containerLayout = (LinearLayout) findViewById(R.id.id_add_container);
        addDuringCardView = (CardView) findViewById(R.id.cv_add);
        saveBtn = (TextView) findViewById(R.id.tv_save);
        titleText = (TextView) findViewById(R.id.id_tv_title);
        cvText = (TextView) findViewById(R.id.id_tv_btn);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timetable_activity_add_timetable2);
        bindView();
        initsData();
    }
    ...
    public void addOneItem() {
        final View itemView = inflate.inflate(R.layout.timetable_item_add, null, false);
    ...
    private void setOnClick() {
        findViewById(R.id.cv_add).setOnClickListener(v -> addItemView());
        findViewById(R.id.tv_save).setOnClickListener(v -> save());
        findViewById(R.id.tv_back).setOnClickListener(v -> goBack());
    }
    ...
    public void showTimeAlert(final AddModel model, final TextView time) {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.timetable_view_select_time, null, false);
    ...
    public void showWeekAlert(final AddModel model, final TextView week) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, AlertDialog.THEME_HOLO_DARK);
        View view = LayoutInflater.from(this).inflate(R.layout.timetable_view_select_week, null, false);
