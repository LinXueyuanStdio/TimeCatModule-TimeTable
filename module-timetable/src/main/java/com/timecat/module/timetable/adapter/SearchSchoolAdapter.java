        ...
        switch (getItemViewType(position)){
            case TYPE_STATION:
                if (convertView == null) {
                    ...
                    convertView = mInflater.inflate(R.layout.timetable_item_search_station, null);
                    ...
                    if(stationModel!=null){
                        ...
                        Glide.with(context).load(stationModel.getImg())
                            .apply(new RequestOptions()
                                .placeholder(R.drawable.timetable_ic_station_placeholder)
                                .error(R.drawable.timetable_ic_station_placeholder))
            ...
            case TYPE_COMMON:
                if (convertView == null) {
                    ...
                    convertView = mInflater.inflate(R.layout.timetable_item_search_school, null);
