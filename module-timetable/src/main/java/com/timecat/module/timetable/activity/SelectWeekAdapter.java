...
public class SelectWeekAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.timetable_item_select_week, null);
        ...
        if(statusList.get(position)){
            ...
            holder.textView.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.timetable_week_selected_bg));
        }else{
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(statusList.get(position)){
                    ...
                    finalHolder.textView.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.timetable_week_selected_bg));
                }
            }
        });
